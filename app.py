...
limited_issues_codes = {"LDOIA", "LD/AFC-MES", "LD/AFCO", "LD/ATC-OPS", "LDPSPFC", "LD/BULLETIN12", "LD/AFC-EMS", "LDAFC-OPS", "RFO", "RFO/OIA", "RFO-AFC-EMS"}
...
def rename_and_type(df):
    ...
    def reclassify_ops_subtype(row):
        ...
        "GW PARAMEDIC PROGRAM STUDENTS"
        }
        if rank in ta_student_ranks:
            return "TA Student"
